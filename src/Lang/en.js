LANG.en = {
	...
	"RaceMenu-TimeTrial-Desc" : "Race against the clock! No actual multiplayer communication, so it'll always work. You can use a PRNG (pseudo random number generator) to get the same set of levels as an opponent.",
	...
	"MultiplayerJoin-InputKey" : "Paste the Room Key",
	...
	"Credits-TranslationBegHead" : "More Languages",
	"Credits-TranslationBegLines" : ["Your name could be here!",
			"Join my Discord if you would like to contribute translations"],
	...
	"TimeTrial-Goal" : "Length",
	"TimeTrial-KongregateNoPRNG" : "In order to submit times to Kongregate, you must not have <lg|Infinite-PRNG> enabled.",
	"TimeTrial-KongregateLength" : "In order to submit times to Kongregate, you must have the <lg|TimeTrial-Goal> set to one of the values above. <br> (You can click on them).",
	"TimeTrial-KongregateYes" : "You are ready to play and submit your time to Kongregate.",
	...
	"SameGame-ColorblindAlert" : "Colorblind mode available in <lg|GameMenu-Settings>",
	...
	"Settings-FontOtherDesc" : "Input any font name. If it's installed on your computer, it can be used in-game.",
