LANG.en = {
	...
	"Credits-TranslationBegLines" : ["Your name could be here!",
			"Contact me if you would like to contribute fan translations"],
	...
	"TimeTrial-KongregateParaStart" : "In order to submit times to Kongregate: <br> You must NOT set a PRNG seed.",
	"TimeTrial-KongregateParaLengthNone" : "Three lengths are allowed depending on category.",
	"TimeTrial-KongregateParaLength" : "For <modename>, you must have a length of <length0>, <length1>, or <length2>.",
	"TimeTrial-KongregateParaReady" : "Your time is eligible for submission.",
