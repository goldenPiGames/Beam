...
const SONG_LIST_ABS = [
	...
	{name:"Boat Paint", intensity:1/4, kong:1, android:1, coolmath:1, armor:1,
		by:"Al Gorgeous", sc:"al-goregous/boat-paint"},
	
	//Asher Please
	{name:"Broken Record Blues", fname:"Sunday Night Sailing", intensity:1/4, kong:1, android:1, coolmath:1, armor:1,
	...
	*/
	...
	{name:"Beatdown City", intensity:3/4, kong:1, android:1, coolmath:1, armor:1,
	...
	{name:"Feel It In Your Feet", intensity:1/2, kong:1, android:1, coolmath:1, armor:1,
	...
	{name:"Decisions", intensity:0, bpm:95.34, kong:1, android:1, coolmath:1, armor:1,
	...
	{name:"Flex", intensity:3/4, kong:1, android:1, coolmath:1, armor:1,
	...
	{name:"Blip Stream", intensity:1/2, chiptune:1, kong:1, android:1, coolmath:1, armor:1,
	...
	{name:"Exit the Premises", intensity:3/4, kong:1, android:1, coolmath:1, armor:1,
	...
	{name:"Fearless First", intensity:1/4, kong:1, coolmath:1, armor:1,
	...
	{name:"March of the Spoons", intensity:1/4, kong:1, android:1, coolmath:1, armor:1,
	...
	{name:"Pixelland", intensity:1/2, chiptune:1, kong:1, android:1, coolmath:1, armor:1,
	...
	{name:"Up In My Jam (All Of A Sudden)", fname:"Up In My Jam", intensity:3/4, kong:1, android:1, coolmath:1, armor:1,
	...
	//ParagonX9
	{name:"Blue Sky", intensity:1/2, kong:1, android:1, coolmath:1, armor:1,
		by:"ParagonX9", yt:"QdL18RWUS8E", ng:5437},
	{name:"Chaoz Fantasy", intensity:3/4, kong:1, coolmath:1, armor:1,
		by:"ParagonX9", yt:"pxIuZC26hXU", sc:"paragonx9/chaozfantasy", ng:85046},
	{name:"Chaoz Fantasy (8-bit)", intensity:3/4, chiptune:1, kong:1, coolmath:1, armor:1,
	...
	{name:"Deep Valley 2", intensity:0, kong:1, android:1, coolmath:1, armor:1,
	...
	{name:"Dramatic", intensity:1, kong:1, coolmath:1, armor:1,
	...
	{name:"Investigation 3", intensity:1/4, kong:1, android:1, coolmath:1, armor:1,
	...
	{name:"Labyrinth", intensity:1/4, kong:1, android:1, coolmath:1, armor:1,
	...
	{name:"Lost Place", intensity:1/2, kong:1, android:1, coolmath:1, armor:1,
	...
	{name:"Prairie 5", intensity:1, kong:1, coolmath:1, armor:1,
	...
	{name:"Steam Fortress", intensity:3/4, kong:1, coolmath:1, armor:1,
	...
	//TheFatRat
	{name:"Unity", intensity:3/4, hop:1, vocals:1, kong:1, coolmath:1, armor:1, //TODO make it loop
	...
	//Ucchii0
	{name:"Collapse of the Labyrinth", intensity:1, chiptune:1, bpm:145, loopStart:108.161, loopEnd:232.294, kong:1, coolmath:1, armor:1,
		by:"Ucchii 0", yt:"RiLqC-sFl6U", sc:"vskktqtpbuqs/chiptunecollapse-of-the-labyrinthucchii0"},
	{name:"Don't Sleep", intensity:1, loopStart:13.81606, loopEnd:97.81608, bpm:160, kong:1, coolmath:1, armor:1,
		by:"Ucchii 0", yt:"pluUDQCBSso", site:"https://creofuga.net/audios/106981", siten:"CreoFuga"},
	{name:"Gambles", intensity:3/4, bpm:155, kong:1, coolmath:1, armor:1,
	...
	{name:"Deadly Sins", intensity:3/4, loopStart:11.475668934240362, loopEnd:90.53138321995465, kong:1, coolmath:1, armor:1,
		by:"YouFulca", site:"https://wingless-seraph.net/material-music_battle.html", siten:"Wingless Seraph", yt:"G3U8PfCP7aw"},
	{name:"Get Along", intensity:3/4, chiptune:1, loopStart:3.5554875283446714, loopEnd:62.29578231292517, armor:1,
		by:"YouFulca", site:"https://wingless-seraph.net/material-music_battle.html", siten:"Wingless Seraph", yt:"TRvJWwL4ZyM"},
	...
	{name:"Never Surrender (8bit)", intensity:3/4, chiptune:1, loopStart:3.3784353741496598, loopEnd:54.23882086167801, kong:1, coolmath:1, armor:1,
		by:"YouFulca", site:"https://wingless-seraph.net/material-music_8bit.html", siten:"Wingless Seraph", yt:"Mxvqy-ImHDo"},
	{name:"まだ見ぬ明日への誓い", fname:"Battle Madaminu", intensity:1, loopStart:5.434172335600907, loopEnd:88.98675736961451, kong:1, coolmath:1, armor:1,
		by:"YouFulca", site:"https://wingless-seraph.net/material-music_battle.html", siten:"Wingless Seraph", yt:"IhNCGXs5hc0"},
	{name:"ステージ4", fname:"Stage 4", intensity:3/4, chiptune:1, loopStart:0.09997732426303856, loopEnd:43.736281179138324, kong:1, android:1, coolmath:1, armor:1,
		by:"YouFulca", site:"https://wingless-seraph.net/material-music_8bit.html", siten:"Wingless Seraph", yt:"bqcapw3Utsc"},
	{name:"ステージ5", fname:"Stage 5", intensity:1/2, chiptune:1, loopStart:7.65827664399093, loopEnd:56.79172335600907, kong:1, android:1, coolmath:1, armor:1,
		by:"YouFulca", site:"https://wingless-seraph.net/material-music_8bit.html", siten:"Wingless Seraph", yt:"xfU3w1EEUv8"},
	{name:"レイピアを継ぐ少女", fname:"Battle Rapier", intensity:1, loopStart:9.5762358276644, loopEnd:72.32124716553288, kong:1, android:1, coolmath:1, armor:1,
		by:"YouFulca", site:"https://wingless-seraph.net/material-music_battle.html", siten:"Wingless Seraph", yt:"CFWxY_tKIo4"},
	{name:"勝利を信じて", fname:"Battle 1", intensity:3/4, chiptune:1, loopStart:6.1998185941043085, loopEnd:54.19823129251701, kong:1, android:1, coolmath:1, armor:1,
		by:"YouFulca", site:"https://wingless-seraph.net/material-music_8bit.html", siten:"Wingless Seraph", yt:"6FMTEYygdDc"},
	{name:"決戦の地へ", fname:"Dungeon 03", intensity:1/2, chiptune:1, loopStart:18.659954648526078, loopEnd:77.73732426303854, kong:1, android:1, coolmath:1, armor:1,
		by:"YouFulca", site:"https://wingless-seraph.net/material-music_8bit.html", siten:"Wingless Seraph", yt:"F1rtW51JJPE"},
	{name:"神秘の海を越えて", fname:"Voyage", intensity:0, loopStart:14.865419501133786, loopEnd:125.07396825396826, kong:1, android:1, coolmath:1, armor:1,
		by:"YouFulca", site:"https://wingless-seraph.net/material-music_field.html", siten:"Wingless Seraph"},
	{name:"遥かなる冒険", fname:"Field 01", intensity:1/4, chiptune:1, loopStart:4.933741496598639, loopEnd:65.56698412698412, kong:1, android:1, coolmath:1, armor:1,
		by:"YouFulca", site:"https://wingless-seraph.net/material-music_8bit.html", siten:"Wingless Seraph", yt:"HTtf-twdDTo"},
]
